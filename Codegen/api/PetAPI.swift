...
//        let pet2 = Pet(_id: 2, category: nil, name: "Doggie", photoUrls: [], tags: nil, status: .sold)
//        let pet3 = Pet(_id: 3, category: nil, name: "Dolly", photoUrls: [], tags: nil, status: .pending)
//        let pets = [pet1, pet2, pet3]
//        completion(.success(pets))
        
        SwaggerClientAPI.PetAPI.findPetsByStatus(status: [status.rawValue]) { (response, error) in
